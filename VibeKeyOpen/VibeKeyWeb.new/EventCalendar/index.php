...
//                     dp.events.add(e);
                ...
                dp.onEventClick = function(args) {
                    ...
                    console.log("start from " + args.e.start + " to " + args.e.end);
                    $('#time').html("start from " + args.e.start + " to " + args.e.end);
                    $('sName').html("thisName");
            ...
            <script type="text/javascript">
   				$(function () {  
					...
					function() {	
						...
						console.log(sName + "-" + sDescrip + "-" + sRepeat + "-" + sType + "-" + args_start + "-" + args_end);
