...
function search_for_stream() {
	var searchWord = document.getElementById('search_key_stream').value;
	var allsongsRef = new Firebase(FIREBASE_REF).child("songs").child("allSongs");
	var search_result = document.getElementById('search_result_stream');
